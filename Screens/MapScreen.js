...
const MapScreen = () => {
    ...
    const [message, setMessage] = useState('Select your Country');

    // Function to handle press event on Bangladesh (when the map is clicked)
    const handlePressBangladesh = () => {
        console.log('Bangladesh clicked');
        setMessage('Welcome to Bangladesh!');
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground
                source={require('../assets/images/map.png')}  // Make sure to use the correct path for your map image
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        fontWeight: 'bold',
        position: 'absolute',
        top: 200,  // Adjust this value to position the text at the top of the screen
        textAlign: 'center',
        width: '100%',
    },
    touchArea: {
